...
export function SolutionCtaFooter(): ReactNode {
  return (
    <div className="solution-cta-footer mx-auto mt-18 max-w-432 border-x border-grey-20 bg-black md:mt-24 lg:mt-32 xl:mt-37">
      <CTA
