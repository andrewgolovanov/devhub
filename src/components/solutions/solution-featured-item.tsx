    ...
    <article className="feature-post grid gap-0 lg:grid-cols-[2fr_3fr] lg:gap-10.75 xl:grid-cols-[30rem_minmax(0,1fr)]">
      <div className="relative flex min-h-82 flex-col md:min-h-92 lg:min-h-0 lg:overflow-hidden lg:[contain:size] xl:overflow-visible xl:[contain:none] 2xl:h-132.75">
        ...
        <AnimatedArrowLink
          ...
          className="border-orange text-orange hover:text-db-lava-light focus-visible:outline-db-cyan mt-8 flex w-full items-center justify-between border-b-3 pb-2.5 text-xl leading-snug font-normal tracking-[-0.04em] no-underline transition-colors duration-200 focus-visible:outline-2 focus-visible:outline-offset-4 md:mt-9 md:text-2xl lg:mt-auto lg:shrink-0 lg:text-[28px] xl:mt-12 xl:text-[2rem] 2xl:absolute 2xl:bottom-0 2xl:left-0 2xl:mt-0"
