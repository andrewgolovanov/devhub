...
function NavItemChrome({
  ...
  return (
    ...
    >
      <span
        className="pointer-events-none absolute inset-0 overflow-hidden bg-grey-12 opacity-0 group-hover/nav-item:opacity-100 group-data-[state=open]/product-trigger:opacity-100 group-data-[active=true]/nav-item:opacity-100"
        aria-hidden="true"
      >
...
function ProductDropdown({
  ...
  return (
    <div
      className="relative h-[111px] w-[185px] bg-grey-12 font-mono text-sm leading-none text-white"
        ...
        {PRODUCT_LINKS.map((product) => {
          ...
          return (
            <NavigationMenuLink
              ...
              asChild
              className={cn(
                "!flex !h-[22px] !w-full !flex-row !items-center !gap-0 !rounded-none !bg-transparent !px-2 !py-1 font-mono text-sm leading-none tracking-normal no-underline !transition-none outline-none hover:!bg-transparent hover:no-underline focus:!bg-transparent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-db-cyan data-[active=true]:!bg-transparent",
          ...
          if (label === "Product") {
            ...
            return (
              ...
              >
                ...
                <NavigationMenuContent className="z-60 mt-0! h-[111px]! w-[185px]! overflow-visible! rounded-none! border-0! bg-grey-12! p-0! shadow-none! !transition-none !duration-0 data-[motion^=from-]:!animate-none data-[motion^=to-]:!animate-none data-[state=closed]:!animate-none data-[state=open]:!animate-none group-data-[viewport=false]/navigation-menu:!duration-0 group-data-[viewport=false]/navigation-menu:data-[state=closed]:!animate-none group-data-[viewport=false]/navigation-menu:data-[state=open]:!animate-none">
                  <ProductDropdown
