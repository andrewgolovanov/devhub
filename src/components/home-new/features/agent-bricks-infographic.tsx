...
const israelGrantSrc = "/img/home-new/features/israel-grant.jpg";
const agentBricksIconSrc = "/img/home-new/features/agent-bricks-icon.svg";
const lockIconSrc = "/img/home-new/features/lock-icon.svg";
