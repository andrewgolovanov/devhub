  ...
  return (
    ...
    >
      <div className="relative z-10 mx-auto flex flex-col px-5 py-18 max-w-272 xl:max-w-304 md:px-8 md:py-24 lg:py-32 xl:py-46 2xl:max-w-376">
        ...
        <ul className="relative z-10 mt-10 grid gap-10 md:mt-28 md:grid-cols-2 md:gap-8 lg:gap-20 lg:mt-44 xl:mt-46 xl:gap-24 2xl:gap-56">
      ...
      <div
        ...
        aria-hidden="true"
      >
        <div className="absolute top-0 left-1/2 h-30 w-61 translate-x-1/4 [background-image:radial-gradient(circle_at_1px_1px,rgb(255_255_255)_1px,transparent_0)] bg-size-[6px_6px] sm:hidden lg:block lg:translate-x-1/6 lg:h-60 lg:w-100 lg:right-auto lg:left-[calc(50%-4em)] xl:h-85 xl:w-140 xl:left-[calc(50%-3em)] 2xl:h-94 2xl:w-170 2xl:left-[calc(50%-2em)] 2xl:translate-x-1/6" />
        <div className="absolute hidden top-57 -right-1/2 h-98 w-145 [background-image:radial-gradient(circle_at_1px_1px,rgb(255_255_255)_1px,transparent_0)] bg-size-[6px_6px] lg:block lg:right-[calc(50%+27rem)] lg:top-100 lg:h-62 lg:w-80 xl:right-[calc(50%+31.125rem)] xl:top-130 xl:h-84 xl:w-145 2xl:h-98 2xl:right-[calc(50%+29.75rem)] 2xl:w-145 2xl:top-158" />
        <div className="absolute hidden top-66 right-1/2 h-48.5 w-45 [background-image:radial-gradient(circle_at_1px_1px,rgb(255_255_255)_1px,transparent_0)] bg-size-[6px_6px] lg:block lg:right-[calc(50%+20.25rem)] lg:top-100 lg:h-26 lg:w-26 xl:right-[calc(50%+22rem)] xl:top-130 xl:h-36 xl:w-36 2xl:h-45 2xl:right-[calc(50%+17.5rem)] 2xl:w-48.5 2xl:top-158" />
      </div>
    </section>
  );
}
