...
- **Agentic Support Console**: Build a complete operational data application featuring Lakebase persistence, Change Data Feed, a medallion pipeline, and a Databricks App with Genie analytics, all scaffolded by an AI agent.
