...
- **A scaffolded AppKit app with Lakebase wired up.** Complete the [Create a Lakebase Project](/templates/lakebase-create-instance) and [Lakebase Data Persistence](/templates/lakebase-data-persistence) templates first. This template adds chat tables on top of that setup.
