...
Templates tell you _how_ to build something. The docs explain _what_ the underlying platform actually is, so you (and your agent) can make informed decisions. Each page is short and opinionated. It's meant to be just enough so you understand how the services and components fit together.
...
The way developers ship software is changing, and the content we read has to work for our agents too. Every template (and docs page) on the site is:
